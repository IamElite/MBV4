...
from ERAVIBES import config
from ERAVIBES.helpers import Track
...
class Thumbnail:
    def __init__(self):
        ...
        self.font1 = ImageFont.truetype("ERAVIBES/helpers/font.ttf", 30)
        self.font2 = ImageFont.truetype("ERAVIBES/helpers/font2.ttf", 30)
