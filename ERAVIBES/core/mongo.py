...
from ERAVIBES import config, logger, userbot
...
class MongoDB:
    def __init__(self):
        ...
        self.assistant = {}
        self.assistantdb = self.db.assistants
        ...
        self.users = []
        self.usersdb = self.db.tgusersdb
    ...
    async def get_admins(self, chat_id: int, reload: bool = False) -> list[int]:
        from ERAVIBES.helpers._admins import reload_admins
    ...
    async def get_assistant(self, chat_id: int):
        ...
        return era.clients[self.assistant[chat_id] - 1]
